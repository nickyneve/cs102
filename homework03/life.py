...
class GameOfLife:
    ...
    def cell_list(self, randomize=True):
        ...
        """
        if randomize:
            self.clist = [[random.choice([0, 1]) for x in range(self.width // self.cell_size)] for y in
                          range(self.height // self.cell_size)]
        else:
            self.clist = [[0 for x in range(self.width // self.cell_size)] for y in
                          range(self.height // self.cell_size)]
        return self.clist
    ...
    def draw_cell_list(self, clist):
        ...
        for i in range(self.cell_height):
            for j in range(self.cell_width):
                ...
                d = self.cell_size - 1
                if clist[i][j]:
                    pygame.draw.rect(self.screen, pygame.Color('green'), (a, b, c, d))
                else:
                    pygame.draw.rect(self.screen, pygame.Color('white'), (a, b, c, d))
